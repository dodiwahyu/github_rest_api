  ...
  String getFork() {
    if (forksCount != null) {
      if (forksCount! > 1000000) {
        return '${(forksCount! / 1000000).round()}M';
      } else if (forksCount! > 1000) {
        return '${(forksCount! / 1000).round()}K';
      } else {
        return '${forksCount!}';
      }
    } else {
  ...
  String getStarCount() {
    if (stargazersCount != null) {
      if (stargazersCount! > 1000000) {
        return '${(stargazersCount! / 1000000).round()}M';
      } else if (stargazersCount! > 1000) {
        return '${(stargazersCount! / 1000).round()}K';
      } else {
